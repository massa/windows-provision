...
Invoke-WebRequest -Uri https://github.com/microsoft/winget-cli/releases/download/v1.4.10052/Microsoft.DesktopAppInstaller_8wekyb3d8bbwe.msixbundle -OutFile C:\Windows\system32\Microsoft.DesktopAppInstaller_8wekyb3d8bbwe.msixbundle
